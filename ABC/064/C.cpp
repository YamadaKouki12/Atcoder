...
signed main(){
    ...
    rep(i,n){
        int a; cin >> a;
        if(a<400) rate[0]++;
        else if(a<800) rate[1]++;
        else if(a<1200) rate[2]++;
        else if(a<1600) rate[3]++;
        else if(a<2000) rate[4]++;
        else if(a<2400) rate[5]++;
        else if(a<2800) rate[6]++;
        else if(a<3200) rate[7]++;
        else rate[8]++;
    }
    
    int cnt=0;
    rep(i,8)if(rate[i]>0)cnt++;
    
    cout<<max(cnt,1LL)<<' '<<cnt+rate[8]<<endl;
}