...
signed main(){
    ...
    else if(s=="BWBWWBWBWBWWBWBWWBWW") cout<<"Re"<<endl;
    else if(s=="WBWWBWBWBWWBWBWWBWWB") cout<<"Mi"<<endl;
    else if(s=="BWWBWBWBWWBWBWWBWWBW") cout<<"Fa"<<endl;
    else if(s=="WWBWBWBWWBWBWWBWWBWB") cout<<"So"<<endl;
    else if(s=="WBWBWBWWBWBWWBWWBWBW") cout<<"La"<<endl;
    else cout<<"Si"<<endl;
}